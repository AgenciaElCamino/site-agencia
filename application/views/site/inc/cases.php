<section class="cases one">
    ...
    <div class="case casamob" data-case="casamob" data-lang="<?= $lang ?>" data-aos="fade-right" data-aos-duration="1000">
        <div class="case-info-holder">
            <div class="show-case"></div>
            <div class="case-name-border"></div>
    ...
    <div class="case natal-ford" data-case="natal-ford" data-lang="<?= $lang ?>" data-aos="fade-down" data-aos-duration="1000">
        <div class="case-info-holder">
            <div class="show-case"></div>
            <div class="case-name-border"></div>
            <p class="case-name">natal_ford</p>
        </div>
    </div>
</section>
